...
import bannerImgUrl from '../assets/images/patri1.jpg'
import descripcionImgUrl from '../assets/images/patri2.jpg'
import ofrecemosImgUrl from '../assets/images/patri3.jpg'
